    ...
    <div class="container">
        ...
        <form action="{{ route('chevaux.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="poids" id="poids" class="form-control" value="{{ old('poids') }}" required>
            </div>
            ...
            <button type="submit" class="btn btn-primary mt-3">Créer le cheval</button>
        </form>
    </div>
@endsection
